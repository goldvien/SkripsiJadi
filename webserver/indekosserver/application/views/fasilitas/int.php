<?php $this->load->view('header'); foreach($internal->result() as $int);?>
	<div class="span4">
		<section>
			<div class="page-header">
				<h4>Tambah Fasilitas Internal</h4>
			</div>
			<form class="form-vertical" method="post" action="<?php echo base_url().'fasilitas/tambahint';?>">
				<table class="table table-striped">
					...
					<tbody>
						<tr>
							...
							<td><input type="hidden" name="pemilik_id"value="<?php echo $int->pemilik_id;?>">
