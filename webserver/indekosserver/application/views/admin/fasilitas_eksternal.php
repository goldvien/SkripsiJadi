	...
	<div class="span4">
		<section>
			<div class="page-header">
				<h4>Tambah Fasilitas Eksternal</h4>
			</div>
			<form class="form-vertical" method="post" name="fasilitas_eks" action="<?php echo base_url().'admin/fasilitas_eksternal_tambah';?>">
				<table class="table table-striped">
					...
					<tbody>
						<tr>
							...
							<td><input type="hidden" name="kab_kota_id"value="<?php echo $kab_kota_id;?>"><input type="text" name="kab_kota_nama" id="kab_kota_nama" value="<?php echo $kab_kota_nama;?>" readonly>
						...
						<tr>
							...
							<td><input type="text" name="fasilitas_eks_nama" id="fasilitas_eks_nama" placeholder="FASILITAS NAMA" required>
							<?php echo form_error('fasilitas_eks_nama');?></td>
						</tr>
						<tr>
							<td><a href="#" onclick="javascript: newWindow('<?=base_url();?>admin/fasilitas_eksternal_peta/<?php echo $kab_kota_id;?>','window2')" class="btn btn-primary"><img src="<?php echo base_url().'assets/img/icons/36/maps.png';?>"></a>&nbsp;</td><td>
							<input type="text" name="fasilitas_eks_long" value="0" placeholder="LONGITUDE" class="input-small" required readonly> 
							<input type="text" name="fasilitas_eks_lat" value="0" placeholder="LATITUDE" class="input-small" required readonly>
