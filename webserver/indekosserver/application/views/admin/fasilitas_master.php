...
<div class="span4">
		<section>
			...
			<form class="form-vertical" method="post" action="<?php echo base_url().'admin/fasilitas_master_tambah';?>" enctype="multipart/form-data">
				<table class="table table-striped">
					...
					<tbody>
						<tr>
							...
							<td><input type="text" name="fasilitas_master_nama" id="fasilitas_master_nama" placeholder="FASILITAS NAMA" required><?php echo form_error('fasilitas_master_nama');?></td>
						</tr>
						<tr>
							<td><label class="control-label" for="fasilitas_master_icon">ICON</label></td>
							<td><input type="file" name="userfile" id="fasilitas_master_icon" required><?php echo form_error('fasilitas_master_icon');?></td>
						</tr>
						<tr>
