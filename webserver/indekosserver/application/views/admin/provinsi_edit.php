...
foreach($edit->result() as $edit);?>
	<div class="span4">
		<section>
			<div class="page-header">
				<h4>Edit Provinsi</h4>
			</div>
			<form class="form-vertical" method="post" action="<?php echo base_url().'admin/provinsi_ubah';?>">
				<table class="table table-striped">
					...
					<tbody>
						<tr>
							...
							<td><input type="hidden" name="provinsi_id" value="<?php echo $edit->provinsi_id;?>" readonly><input type="text" name="provinsi_kode" value="<?php echo $edit->provinsi_kode;?>" id="provinsiKode" placeholder="PROVINSI KODE" required><?php echo form_error('provinsi_kode');?></td>
						</tr>
						<tr>
							<td><label class="control-label" for="provinsiNama">NAMA</label></td>
							<td><input type="text" name="provinsi_nama" value="<?php echo $edit->provinsi_nama;?>" id="provinsiNama" placeholder="PROVINSI NAMA" required><?php echo form_error('provinsi_nama');?></td>
						</tr>
						<tr>
