...
public class LocalDatabase {
	...
	public Cursor get_jarak_terdekat() throws SQLException {
		Cursor select = mDb
				.rawQuery(
						"SELECT jarak_terdekat._id, jarak_terdekat.indekos_id,jarak_terdekat.jarak,kamar.kamar_id, kamar.kamar_kontrak_status,"
								+ "indekos.indekos_nama, indekos.indekos_untuk, indekos.indekos_keterangan, count(kamar.kamar_id) AS jumlah "
								+ "FROM indekos, kamar, jarak_terdekat WHERE "
								+ "jarak_terdekat.indekos_id=indekos.indekos_id AND indekos.indekos_id=kamar.indekos_id AND "
								+ "kamar.kamar_kontrak_status='kosong' GROUP BY indekos.indekos_id ORDER BY jarak_terdekat.jarak ASC",
						null);
