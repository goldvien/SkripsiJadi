...
public class DetailKamar extends ListActivity {
	...
	private TextView kamarnama, kamarisi, kamarukuranpanjang, kamarukuranlebar,
			kamarukuranjenis, kamarharga, kamarminkontrak,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				try{
				Intent intent = new Intent(DetailKamar.this, ImageFotoKamar.class);
				intent.putExtra("urlfoto", URLimage+foto);
				intent.putExtra("nama_kamar",  kamarnama.getText().toString());
